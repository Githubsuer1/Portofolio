...
const Contact = ()=>{
    return (
        <div className="p-4 w-full h-full md:h-screen bg-gray-800 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4  gap-3 justify-items-center">
            ...
            >
                ...
                alt="" 
                className='rounded-full h-96 overflow-hidden w-full border-green-300 border-2'
                />
                <p className='text-center py-1.5 border-2 border-green-300 text-green-300 font-bold rounded'>LinkedIn</p>
            </NavLink>
            ...
            >
                ...
                className='rounded-full h-96 overflow-hidden w-full border-green-300 border-2'
                />
                <p className='text-center py-1.5 border-2 border-green-300 text-green-300 font-bold rounded'>Github</p>
            </NavLink>
            ...
            >
                ...
                className='rounded-full h-96 overflow-hidden w-full border-green-300 border-2'
                />
                <p className='text-center py-1.5 border-2 border-green-300 text-green-300 font-bold rounded'>X</p>
            </NavLink>
            ...
            >
                ...
                className='rounded-full h-96 overflow-hidden w-full border-green-300 border-2'
                />
                <p className='text-center py-1.5 border-2 border-green-300 text-green-300 font-bold rounded'>FaceBook</p>
            </NavLink>
        </div>
    )
}
